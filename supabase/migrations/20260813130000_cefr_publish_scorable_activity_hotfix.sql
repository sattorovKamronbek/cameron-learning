-- A CEFR gap-fill or matching part is scored from its own answer-key tables,
-- not from contest_questions.  The former generic publish gate consequently
-- rejected fully configured parts as “questionless”.  Keep empty parts blocked,
-- while accepting every supported kind of scorable activity.
